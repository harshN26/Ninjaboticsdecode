...
public class OneShift extends SequentialCommandGroup {

    public OneShift(TurretShooter shooter, ChamberSort chamberSort, Intake intake){
        super(
                new SequentialCommandGroup(
                        ...
                        new InstantCommand(()->intake.update(Intake.INTAKE_STATE.OUT)),
                        new InstantCommand(()->chamberSort.update(ChamberSort.CHAMBER_STATE.OUT)),
                        new WaitCommand(200),
