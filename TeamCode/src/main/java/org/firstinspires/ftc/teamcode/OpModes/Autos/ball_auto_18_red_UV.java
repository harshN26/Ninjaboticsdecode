...
//@Disabled
@Autonomous(name="red18UV")
public class ball_auto_18_red_UV extends OpMode {
...
//        shooter.offsetConstant=15;
        ...
        CommandScheduler.getInstance().schedule(
                ...
                new SequentialCommandGroup(
                        ...
                        new ParallelRaceGroup(
                                new ShootAllAUTOCLOSE(shooter,sort,intake),
                                new WaitUntilCommand(()->timer.milliseconds()>1350)
                        ),
                        new InstantCommand(()->shooter.update(TurretShooter.shooterState.IDLE)),
...
//        PathChain shoot1, shoot2, shoot3;
        ...
        shoot2 = follower
                .pathBuilder()
                .addPath(
                        new BezierCurve(new Pose(130.000, 55.000), new Pose(120.000, 56.000),Constants.autoCloseREDShoot)
                )
        ...
        shootFromGate=follower
                .pathBuilder()
                .addPath(
                        new BezierCurve(new Pose(134.000, 55.500), new Pose(130,53),Constants.autoCloseREDShoot)
                )
        ...
        collectBalls1 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(Constants.autoCloseREDShoot, new Pose(125.000, 79.000))
                )
        ...
        shoot1 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(125.000, 81.000), Constants.autoCloseREDShoot)
                )
                .setVelocityConstraint(0.8)
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(-30))
                .build();
        ...
        shoot3 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(125.000, 36.000), new Pose(Constants.autoCloseREDShoot.getX()+2,Constants.autoCloseREDShoot.getY()+15))
                )
