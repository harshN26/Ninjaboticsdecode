...
public class ShootAll3InertiaAUTO extends SequentialCommandGroup {

    public ShootAll3InertiaAUTO(TurretShooter shooter, ChamberSort chamberSort, Intake intake){
        super(
