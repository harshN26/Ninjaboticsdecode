...
//        shooter.offsetConstant=-12;
        shooter.hoodOffset-=0.5;
...
//        PathChain shoot1, shoot2, shoot3;
        ...
        shoot3 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(18.000, 33.000), new Pose(Constants.autoCloseBLUEShoot.getX(),Constants.autoCloseBLUEShoot.getY()+20))
                )
